  ...
  <div>
    ...
    <v-dialog v-model="dialog"  width="500">
      <v-card>
        ...
        <v-card-text>
          Choose your login method from the options below.  If you are already registered you will proceed directly to the Lobby.  If not you will be given a chance to register after authentication.  
        </v-card-text>
    ...
    <div v-else key="logout">
      <v-btn outline color="white" @click="openLoginDialog">Login</v-btn>
    </div>
  </div>
</template>
